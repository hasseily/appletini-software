...
It models what the port touches: main and auxiliary memory with the //e
bank switches, RamWorks banks through $C073, the language card, the
keyboard, VBL at $C019, the speaker, NEWVIDEO at $C029, and a Phasor in
slot 4 that follows the select rules of appletini-one/hdl/apple/
mockingboard.sv. It renders HGR, SHR and text to images or strings.

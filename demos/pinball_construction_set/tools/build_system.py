...
LOAD_ADDRESS = 0x2000
SAFE_LIMIT = 0xBB00  # default; the PCS port passes --limit
...
def main() -> None:
    ...
    parser.add_argument("--limit", type=lambda v: int(v, 0), default=SAFE_LIMIT,
                        help="the image must end below this address")
    ...
    if end > limit:
        raise SystemExit(
            f"program ends at ${end - 1:04X}, past the ${limit:04X} "

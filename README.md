...
The released demo images listed below are tracked next to their README. Mount
one on an Appletini SmartPort drive (in GSSquared, `-ds7d1=<image>`) and boot it.
Doom's development image is generated by its build; see its README.
